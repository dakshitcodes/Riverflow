...
export interface QuestionCardDocument extends Models.Document {
    title: string;
    totalVotes: number;
    totalAnswers: number;
    tags: string[];
...
const QuestionCard = ({ ques }: { ques: QuestionCardDocument }) => {
            ...
            <div className="relative w-full">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3 text-sm">
                    ...
                    <div className="ml-auto flex items-center gap-1">
                        ...
                        <strong className="text-sm text-gray-400">{ques.author.reputation}</strong>
                    </div>
