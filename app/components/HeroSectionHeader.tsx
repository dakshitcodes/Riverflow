...
// Disable SSR for IconCloud — it generates random UUIDs for canvas IDs
// which causes a server/client hydration mismatch
const IconCloud = dynamic(() => import("@/components/magicui/icon-cloud"), {
    ssr: false,
    loading: () => (
        <div className="flex h-64 w-full items-center justify-center opacity-40">
            <span className="text-sm text-white/50">Loading cloud...</span>
        </div>
    ),
});
